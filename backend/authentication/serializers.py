...
class UserSerializer(serializers.ModelSerializer):
    """
    Main serializer for User registration and management
    """
    ...
    class Meta:
        model = User
        fields = (
            'id', 'username', 'password', 'confirm_password', 'email',  # Updated field name
    ...
    def validate(self, attrs):
        if attrs.get('password') != attrs.get('confirm_password'):  # Updated validation check
            raise serializers.ValidationError({"password": "Password fields didn't match."})
        return attrs
    
    def create(self, validated_data):
        validated_data.pop('confirm_password')  # Updated field name
